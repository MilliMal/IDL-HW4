...
=======
        self.criterion = nn.CrossEntropyLoss(ignore_index=self.tokenizer.pad_id, label_smoothing=self.config['training'].get('label_smoothing', 0.0))
>>>>>>> 831413eaeadf5f05cba7d14ca63be230393dcc9b
